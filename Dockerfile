...
RUN apt-get update && apt-get install -y nano nginx jpegoptim optipng pngquant gifsicle htop curl wget zip unzip git jq fail2ban gettext-base software-properties-common supervisor sqlite3 && add-apt-repository -y ppa:ondrej/php && apt-get update && apt-get install -y php7.4-bcmath php7.4-fpm php7.4-cli php7.4-common php7.4-intl php7.4-gd php7.4-intl php7.4-mysql php7.4-pgsql php7.4-sqlite php7.4-sqlite3 php7.4-pdo php7.4-imap php7.4-memcached php7.4-mbstring php7.4-imagick php7.4-xml php7.4-zip php7.4-curl php7.4-xdebug && php -r "readfile('http://getcomposer.org/installer');" | php -- --install-dir=/usr/bin/ --filename=composer && mkdir /run/php && apt-get remove -y --purge software-properties-common && apt-get -y autoremove && apt-get clean && rm -rf /var/lib/apt/lists/* /tmp/* /var/tmp/*
